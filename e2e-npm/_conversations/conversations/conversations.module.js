...
const conversations_write_controller_1 = require("./conversations.write.controller");
...
exports.ConversationsModule = ConversationsModule = __decorate([
    (0, common_1.Module)({
        controllers: [conversations_controller_1.ConversationsController, conversations_write_controller_1.ConversationsWriteController],
        providers: [],
    })
], ConversationsModule);
